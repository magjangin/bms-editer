...
BMS Editer 프로젝트의 설계 아키텍처, 기술적 구현 원리, 기능 사양서, 이슈 트래커를 정리한 문서 허브입니다.
...
│   ├── code_explanation.md        # 소스 코드 전체 구조 및 모듈별 역할 분석
...
* **[code_explanation.md](architecture/code_explanation.md)**: MVVM 아키텍처, `Models`, `Services`, `ViewModels`, `Views/Controls` 디렉터리 내 주요 클래스의 책임과 데이터 흐름을 상세히 설명합니다.
