...
* **[BulkEditViewModel.cs](file:///h:/source/repos/bms%20editer/bms%20editer/ViewModels/BulkEditViewModel.cs)**: 선택된 복수 노트들에 대한 일괄 수정(키음 일괄 변경 등)을 지원하기 위한 상태 모델입니다.
* **[NoteStatsViewModel.cs](file:///h:/source/repos/bms%20editer/bms%20editer/ViewModels/NoteStatsViewModel.cs)**: 채보에 배치된 레인별 노트 개수 및 WAV 키음별 사용 빈도를 집계하여 분석 창에 보여줍니다.
